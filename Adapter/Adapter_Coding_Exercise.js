...
// augmenting it with width/height members,
// please implement the SquareToRectangleAdapter
// class. This adapter takes a square and adapts
//it in such a way that it can be used as an
// argument to calculateArea().
class Square {
    constructor(side) {
        this.side = side;
    }
